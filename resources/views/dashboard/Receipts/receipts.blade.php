                            ...
                            <tbody>
                                @foreach ($receipts as $key => $receipt)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('receipts.edit', $receipt->id) }}" class="btn btn-primary">
                                                <i class="typcn typcn-edit"></i>
                                            </a>
                                            <a href="#delete{{ $receipt->id }}" data-effect="effect-scale"
                                    ...
                                    <div class="modal" id="delete{{ $receipt->id }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">{{ __('receipts.delete_receipt') }}
                                                ...
                                                <form action="{{ route('receipts.destroy', $receipt->id) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <p>{{ __('tables.delete_q') . ' ' . $receipt->student->name . '؟' }}
                                                        </p>
                                                    </div>
