...
@section('content')
    ...
    <div class="row">
        ...
        @endif
        <form action="{{ route('libraries.store') }}" method="post" class="w-100" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="{{ __('library.book_name') }}">
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <select name="classroom" class="form-control">
                            <option selected disabled label="@lang('students.classroom')"></option>
                        </select>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <select name="section" class="form-control">
                            <option selected disabled label="@lang('students.section')"></option>
                        </select>
                    </div>
                </div>
            </div>
