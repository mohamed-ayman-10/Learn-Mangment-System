...
@section('content')
    ...
    <div class="row row-sm py-3">
                ...
                <div class="card-body">
                    <div class="pl-0">
                        <div class="main-profile-overview">
                            ...
                            <div class="d-flex">
                                <div class="w-100">
                                    <h5 class="main-profile-name text-center">{{ $student->name }}</h5>
                                    <p class="main-profile-name-text">{{ $student->email }}</p>
        ...
        <div class="col-xl-8">
            <form class="form-horizontal" action="{{ url('student/dashboard/profile/' . $student->id) }}" method="POST">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="email" name="email" class="form-control"
                                        placeholder="@lang('teachers.email')" value="{{ $student->email }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
