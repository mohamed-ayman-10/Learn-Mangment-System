    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        @foreach (App\Models\Student::where('guardian_id', Auth::user()->id)->get() as $student)
                            <div class="col-lg-3 col-md-4">
                                <div class="card mx-auto">
                                    <img src="{{ asset('assets/images/my_son.png') }}" class="card-img-top" alt="...">
                                    <div class="card-body {{ app()->getLocale() == 'en' ? 'text-left' : '' }}">
                                        <h5 class="card-title text-center">@lang('guardians.student_info')</h5>
                                        <p class="card-text"><b>@lang('students.grade'): </b>{{ $student->grade->name }}</p>
                                        <p class="card-text"><b>@lang('students.classroom'): </b>
                                            {{ $student->classroom->class_name }}
                                        </p>
                                        <p class="card-text"><b>@lang('students.section'):
                                            </b>{{ $student->section->section_name }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
