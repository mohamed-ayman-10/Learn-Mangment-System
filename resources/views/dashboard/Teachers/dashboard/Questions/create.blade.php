...
@section('content')
    ...
    <div class="row">
        ...
        <form action="{{ route('questions.store') }}" method="post" class="w-100">
            ...
            <div class="form-group">
                <label class="form-label mt-4 mb-3 lh-0">
                    @lang('exam.answers') - <span class="text-danger">@lang('exam.question,')</span>
                </label>
                {{-- <label class="text-danger m-0">@lang('exam.question,')</label> --}}
