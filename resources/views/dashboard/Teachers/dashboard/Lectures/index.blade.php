        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    <a href="{{ route('lectuer.create') }}" class="btn btn-primary">@lang('lectures.lectures_create')</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($lectures as $key => $lecture)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('lectuer.edit', $lecture->id) }}" class="btn btn-primary">
                                    ...
                                    <div class="modal" id="delete{{ $lecture->id }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                ...
                                                <form action="{{ route('lectuer.destroy', $lecture->id) }}" method="POST">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
                                                    <div class="modal-body">
                                                        <p>{{ __('tables.delete_q') . ' ' . $lecture->topic . '؟' }}
                                                        </p>
                                                    </div>
