        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    <a href="{{ route('fees.create') }}" class="btn btn-primary">@lang('fees.create')</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap text-center" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('sections.Grade_name')</th>
                                    <th>@lang('classroom.class_name')</th>
                                ...
                                @foreach ($fees as $key => $fee)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#delete{{ $fee->id }}" data-effect="effect-scale"
                                    ...
                                    <div class="modal" id="delete{{ $fee->id }}">
                                            ...
                                            <div class="modal-content modal-content-demo">
                                                ...
                                                <form action="{{ route('fees.destroy', $fee->id) }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>{{ __('tables.delete_q') . ' ' . $fee->title . '؟' }}
                                                        </p>
                                                    </div>
